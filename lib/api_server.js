...
Server.prototype.handle_get_workspace = function (req, res) {
  ...
  candidates = self.controller.get_copy_candidates(workspace);
...
Server.prototype.handle_get_stats = function (req, res) {
  ...
  stats.active_workspaces = _.map(self.controller.server_mapping.workspaces, function (server, workspace_id) {
    return {
      id: workspace_id,
