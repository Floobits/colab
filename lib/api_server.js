...
const Server = function (server, controller) {
  ...
  app.post("/master/colab/:colab_name/drain", auth, self.handle_drain.bind(self));
  // Delete workspace globally
  app.delete("/master/workspace/:workspace_id", auth, self.handle_delete_workspace.bind(self));
  // Delete locally only
  app.delete("/workspace/:workspace_id", auth, delete_workspace_by_id.bind(app, server));
  app.post("/master/workspace/:workspace_id/pin", auth, self.handle_pin_workspace.bind(self));
  app.post("/master/workspace/:workspace_id/evict", auth, self.handle_evict_workspace.bind(self));
  app.post("/master/motd", auth, self.handle_motd.bind(self));
  app.post("/master/wallops", auth, self.handle_wallops.bind(self));
