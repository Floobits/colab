...
const Server = function (server) {
  ...
  app.get("/master/p/:path", self.handle_get_workspace_by_path.bind(self));
  app.get("/master/p/:owner/:workspace", self.handle_get_workspace_by_name.bind(self));
  app.get("/master/r/:owner/:workspace", self.handle_get_workspace_by_name.bind(self));
  app.get("/master/t/:token", self.handle_request.bind(self, "token"));
  app.get("/master/u/:username", self.handle_request.bind(self, "username"));
  app.get("/master/workspace/:workspace_id", self.handle_get_workspace.bind(self));
  app.get("/master/workspace/:workspace_id/active", self.handle_get_active_workspace.bind(self));
  app.get("/master/workspaces/active", self.handle_get_active_workspaces.bind(self));
  app.get("/master/user/:username/now_editing", self.handle_get_user_now_editing.bind(self));
  app.get("/master/users/active", self.handle_get_active_users.bind(self));
  app.get("/master/tags/active", self.handle_get_active_tags.bind(self));
  ...
  self.app.post("/master/colab/:colab_name/drain", auth, self.handle_drain.bind(self));
  // Delete workspace globally
  self.app.delete("/master/workspace/:workspace_id", auth, self.handle_delete_workspace.bind(self));
  // Delete locally only
  self.app.delete("/workspace/:workspace_id", auth, delete_workspace_by_id.bind(app, server));
  self.app.post("/master/workspace/:workspace_id/pin", auth, self.handle_pin_workspace.bind(self));
  self.app.post("/master/workspace/:workspace_id/evict", auth, self.handle_evict_workspace.bind(self));
  self.app.post("/master/motd", auth, self.handle_motd.bind(self));
  self.app.post("/master/wallops", auth, self.handle_wallops.bind(self));
};
