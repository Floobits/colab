...
ColabServer.prototype.on_conn_end = function (agent_conn) {
  ...
  if (_.isFinite(agent_conn.joined_at) && agent_conn.joined_at > 0 && !agent_conn.is_anon) {
    mixpanel.people.increment(agent_conn.user_id, {
      "patch_count": agent_conn._patch_count,
      "patch_bytes": agent_conn._patch_bytes,
      "odometer": Math.round((Date.now() / 1000) - agent_conn.joined_at)
    });
  }
