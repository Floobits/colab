...
Solicitation.prototype.to_json = function (action) {
  ...
  if (this.solicitation) {
    data.solicitation_id = this.solicitation.id;
  }
  return data;
};
...
Solicitation.prototype.finish = function (agent, data, cb) {
  ...
  auto = {
    ...
    solicitation_create: ["workspace_get", function (cb, res) {
      api_client.solicitation_create({
        workspace: res.workspace_get.id,
    ...
    work_create: ["workspace_get", "solicitation_create", function (cb, res) {
      api_client.work_create({
        solicitation: res.solicitation_create.id,
  ...
  async.auto(auto, function (err, result) {
    ...
    this.work = result.work_create;
    this.solicitation = result.solicitation_create;
