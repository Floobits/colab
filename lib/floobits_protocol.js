...
FloobitsProtocol.prototype.handle_msg_ = function (msg) {
  ...
  case "request_credentials":
    self.handler = new CredentialsHandler(self, self.auth_timeout_id);
  ...
  case "supply_credentials":
    ...
    break;
  case "create_user":
    self.handler = new CreateUserHandler(self, self.auth_timeout_id);
    self.handler.create(msg);
    break;
  default:
    self.handler = new AgentHandler(self, self.auth_timeout_id);
    self.handler.auth(msg);
    break;
  }
  self.emit("on_handler", self.handler);
