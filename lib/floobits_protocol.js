...
FloobitsProtocol.prototype.handle_msg = function (msg) {
  ...
  case "request_credentials":
    self.handler = new CredentialsHandler(this);
    return self.handler.request(msg);
  case "supply_credentials":
    self.handler = new CredentialsHandler(this);
    return self.handler.supply(msg);
  case "create_user":
    self.handler = new CreateUserHandler(this);
    return self.handler.create(msg);
  default:
    self.handler = new AgentHandler(this);
    return self.handler.auth(msg);
  }
};
