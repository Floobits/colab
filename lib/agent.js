...
var BROADCAST_ACTIONS = ["create_buf", "delete_buf", "rename_buf", "set_temp_info", "delete_temp_info"];
...
BaseAgentConnection.prototype.on_delete_temp_info = function(req) {
  ...
  self.room.emit("dmp", self, "delete_temp_info", req.data);
};
...
BaseAgentConnection.prototype.on_set_temp_info = function(req) {
  ...
  // TODO: validate and stuff
  self.room.temp_info = _.extend(self.room.temp_info, req.data);
  self.room.emit("dmp", self, "set_temp_info", {data: req.data});
};
