...
var BaseAgentHandler = function (id, conn, server) {
  var self = this;
...
BaseAgentHandler.prototype._is_ssl = function () {
  var self = this;
  if (self.conn) {
...
BaseAgentHandler.prototype.create_user = function (data) {
  var self = this;
...
BaseAgentHandler.prototype.request_credentials = function (data) {
  var self = this,
    creds;
...
BaseAgentHandler.prototype.supply_credentials = function (data) {
  var self = this,
    creds;
...
BaseAgentHandler.prototype.on_patch = function (req_id, req) {
  var self = this,
...
BaseAgentHandler.prototype.on_set_buf = function (req_id, req) {
  var self = this,
    buf = self.room.get_buf(req.id);
...
BaseAgentHandler.prototype.on_get_buf = function (req_id, req) {
  var self = this,
    buf = self.room.get_buf(req.id);
  if (!buf) {
...
BaseAgentHandler.prototype.on_create_buf = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_delete_buf = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_rename_buf = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_highlight = function (req_id, req) {
  var self = this,
    buf,
    valid_range = true;
...
BaseAgentHandler.prototype.on_msg = function (req_id, req) {
  var self = this;
  self.room.on_msg(self, req_id, req.data);
};

BaseAgentHandler.prototype.on_datamsg = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_webrtc = function (req_id, req) {
  if (!_.isArray(req.to) || !req.data) {
    return;
  }
...
BaseAgentHandler.prototype.on_create_term = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_delete_term = function (req_id, req) {
  var self = this;
  self.room.delete_term(self, req_id, req.id);
};

BaseAgentHandler.prototype.on_saved = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.get_term_or_error = function (term_id, owner_only, cb) {
  var self = this,
    term;
...
BaseAgentHandler.prototype.on_update_term = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_term_stdin = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_term_stdout = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_kick = function (req_id, req) {
  var self = this,
    agent;
  ...
  if (agent) {
    if (agent.state < CONN_STATES.DISCONNECTING) {
...
BaseAgentHandler.prototype.on_delete_temp_data = function (req_id, req) {
  var self = this;
  self.room.delete_temp_data(self, req_id, req.data);
};

BaseAgentHandler.prototype.on_set_temp_data = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_pull_repo = function (req_id, req) {
  var self = this;
...
BaseAgentHandler.prototype.on_request_perms = function (req_id, req) {
  var self = this,
    admins,
    timeout,
    now = Date.now();
...
BaseAgentHandler.prototype.on_perms = function (req_id, req) {
  var self = this,
    action = req.action,
    fine_grained_perms = [],
    user,
...
BaseAgentHandler.prototype.on_solicit = function (req_id, req) {
  return this.room.solicit(this, req_id, req);
};

BaseAgentHandler.prototype.disconnect_unauthed_client = function () {
  var self = this;
...
var AgentHandler = function (id, conn, server) {
  var self = this;

  BaseAgentHandler.call(self, id, conn, server);
...
AgentHandler.prototype.handle_msg = function (msg) {
...
AgentHandler.prototype.on_data = function (d) {
  var self = this,
...
AgentHandler.prototype.write = function (name, res_id, json, cb) {
  var self = this,
    str;
...
AgentHandler.prototype._remote_address = function () {
  var self = this;
