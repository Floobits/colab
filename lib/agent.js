...
BaseAgentConnection.prototype._conn_guard = function (f) {
  var self = this;
  function inner(cb) {
...
BaseAgentConnection.prototype.safe_auto = function (auto, cb) {
  var self = this;
...
BaseAgentConnection.prototype.ping = function (req_id) {
  var self = this;
  clearTimeout(self.heartbeat);
  clearTimeout(self.idle_timeout);
...
BaseAgentConnection.prototype.on_solicit = function (req_id, req) {
