...
BaseAgentConnection.prototype.on_webrtc = function (req_id, req) {
  if (!_.isArray(req.to) || !req.data) {
    return;
  }
...
BaseAgentConnection.prototype.on_create_solicit = function (req_id, req) {
  return this.room.create_solicit(this, req_id, req);
};

BaseAgentConnection.prototype.on_accept_solicit = function (req_id, req) {
  return this.room.accept_solicit(this, req_id, req);
};

BaseAgentConnection.prototype.on_delete_solicit = function (req_id, req) {
  return this.room.delete_solicit(this, req_id, req);
};

BaseAgentConnection.prototype.on_finish_solicit = function (req_id, req) {
  return this.room.finish_solicit(this, req_id, req);
};
...
module.exports = {
  ...
  BaseAgentConnection: BaseAgentConnection,
};
