  ...
  handle_msg = function (msg) {
    ...
    if (!self.authenticated) {
      ...
      case "create_user":
        ...
        return perms.create_user(msg.username, function (err, user_info) {
          if (err) {
            self.error(err, true);
          } else {
...
AgentConnection.prototype.remote_address = function () {
  var self = this;
...
SIOAgentConnection.prototype.remote_address = function () {
  var self = this;
  try {
