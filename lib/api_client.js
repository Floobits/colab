...
function solicitations_get_active(cb) {
  let url = util.format("%s/api/solicitations/active", settings.django_base_url);
...
module.exports = {
  ...
  solicitations_get: solicitations_get,
  solicitations_get_active: solicitations_get_active,
  user_auth: user_auth,
  user_create: user_create,
  workspace_get: workspace_get,
  workspace_get_by_id: workspace_get_by_id,
