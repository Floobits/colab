...
ProRoom.prototype.accept_solicit = function (agent, req_id, req) {
  ...
  s.accept(agent, req);
  self.broadcast("accept_solicit", agent, req_id, req);
};
...
ProRoom.prototype.delete_solicit = function (agent, req_id, req) {
  ...
  delete self.solicitations[req.id];
  self.broadcast("delete_solicit", agent, req_id, req);
};
...
ProRoom.prototype.finish_solicit = function (agent, req_id, req) {
  ...
  delete self.solicitations[req.id];
  self.broadcast("finish_solicit", agent, req_id, req);
};
