    ...
    if (room.require_ssl && !settings.debug) {
      ...
      if (agent && agent.conn && agent.conn.manager) {
        ...
        default:
          ...
          return cb("This workspace requires SSL, but we can't figure out whether your connection is secure. Erring on the side of caution and disconnecting you. This is probably a bug. Sorry.");
        }
      }
    }
