...
var url_regex = new RegExp("(?:https?:\\/\\/)?[-a-zA-Z0-9@:%._\\+~#=]{2,256}\\.[a-z]{2,4}(?::[0-9]{1-5})?\\b([-a-zA-Z0-9@:%_\\+.~#?&//=]*)", "gi");
...
var tree_add_buf = function (tree, buf_path, buf_id) {
  var chunk,
...
var set_state = function (o, state) {
  if (o.state < state) {
    o.state = state;
  } else {
...
var basic_auth = function (name, pass) {
